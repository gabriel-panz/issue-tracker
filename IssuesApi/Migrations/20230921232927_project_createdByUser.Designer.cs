...
namespace IssuesApi.Migrations
{
    ...
    [Migration("20230921232927_project_createdByUser")]
    partial class project_createdByUser
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("IssuesApi.Domain.Entities.IssueItem", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue(new DateTime(2023, 9, 21, 20, 29, 27, 849, DateTimeKind.Local).AddTicks(6343));
            ...
            modelBuilder.Entity("IssuesApi.Domain.Entities.Project", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue(new DateTime(2023, 9, 21, 20, 29, 27, 850, DateTimeKind.Local).AddTicks(7009));
            ...
            modelBuilder.Entity("IssuesApi.Domain.Entities.Tag", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue(new DateTime(2023, 9, 21, 20, 29, 27, 851, DateTimeKind.Local).AddTicks(1342));
            ...
            modelBuilder.Entity("IssuesApi.Domain.Entities.User", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue(new DateTime(2023, 9, 21, 20, 29, 27, 851, DateTimeKind.Local).AddTicks(4778));
