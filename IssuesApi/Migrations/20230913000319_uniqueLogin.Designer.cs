...
namespace IssuesApi.Migrations
{
    ...
    [Migration("20230913000319_uniqueLogin")]
            ...
            modelBuilder.Entity("IssuesApi.Domain.Entities.IssueItem", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue(new DateTime(2023, 9, 12, 21, 3, 19, 314, DateTimeKind.Local).AddTicks(6922));
            ...
            modelBuilder.Entity("IssuesApi.Domain.Entities.Project", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue(new DateTime(2023, 9, 12, 21, 3, 19, 315, DateTimeKind.Local).AddTicks(7684));
            ...
            modelBuilder.Entity("IssuesApi.Domain.Entities.Tag", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue(new DateTime(2023, 9, 12, 21, 3, 19, 316, DateTimeKind.Local).AddTicks(1096));
            ...
            modelBuilder.Entity("IssuesApi.Domain.Entities.User", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue(new DateTime(2023, 9, 12, 21, 3, 19, 317, DateTimeKind.Local).AddTicks(1759));
