...
namespace IssuesApi.Migrations
{
    ...
    [Migration("20230912235227_AddedUsers")]
            ...
            modelBuilder.Entity("IssuesApi.Domain.Entities.IssueItem", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue(new DateTime(2023, 9, 12, 20, 52, 27, 525, DateTimeKind.Local).AddTicks(9413));
            ...
            modelBuilder.Entity("IssuesApi.Domain.Entities.Project", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue(new DateTime(2023, 9, 12, 20, 52, 27, 526, DateTimeKind.Local).AddTicks(9423));
            ...
            modelBuilder.Entity("IssuesApi.Domain.Entities.Tag", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue(new DateTime(2023, 9, 12, 20, 52, 27, 527, DateTimeKind.Local).AddTicks(3067));
            ...
            modelBuilder.Entity("IssuesApi.Domain.Entities.User", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue(new DateTime(2023, 9, 12, 20, 52, 27, 528, DateTimeKind.Local).AddTicks(3436));
